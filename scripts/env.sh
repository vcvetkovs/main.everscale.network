...
HOSTNAME=$(hostname -f)
export EVER_NODE_GITHUB_REPO="https://github.com/everx-labs/ton-labs-node.git"
export EVER_NODE_GITHUB_COMMIT_ID="master"
export EVER_NODE_TOOLS_GITHUB_REPO="https://github.com/everx-labs/ton-labs-node-tools.git"
