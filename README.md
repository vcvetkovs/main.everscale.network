...
Logging configuration is determined by the `main.ton.dev/docker-compose/ever-node/configs/log_cfg.yml` file. By default is contains the recommended configuration for the Rust node.
